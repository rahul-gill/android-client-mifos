...
import org.mifos.client.android.app.search.SearchScreen
import org.mifos.client.android.app.search.SearchViewModel
...
fun HomeNavigationNavHost() {
    ...
    Scaffold(
        ...
        val contentPadding = remember(shouldShowBottomNav, WindowInsets.isImeVisible, lastDestination) {
            //don't apply padding if keyboard is visible on search screen or bottom navigation is hidden
            if (lastDestination == HomeNavigationScreen.SearchScreen &&  isImeVisible || !shouldShowBottomNav)
                ...
                when(screen){
                    HomeNavigationScreen.SearchScreen -> {
                        ...
                        SearchScreen(
                            ...
                            setIsExactMatchEnabled = { viewModel.switchExactMatchEnabled() },
